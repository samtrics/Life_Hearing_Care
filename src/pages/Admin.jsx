...
function Admin() {
  ...
  const handleEditProductClick = (product) => {
    ...
    setProductFormData({
      ...
      image: product.image || '',
      badge: product.badge || '',
      badgeClass: product.badge_class || 'bg-primary text-on-primary',
      features: (product.features || []).join(', '),
      detailsAI: product.details?.ai || '',
      detailsBattery: product.details?.battery || '',
      detailsWater: product.details?.waterResistance || '',
      detailsBluetooth: product.details?.bluetooth || ''
    });
  ...
  const handleSeedDefaultProducts = async () => {
    ...
    const defaults = [
      { name: 'IIC Invisible-in-Canal', brand: 'Life Hearing', price: '₹1,50,000', description: 'The smallest and most discreet hearing aid available, resting deep in the ear canal where it is completely hidden.', image: '/img_invisible.png', badge: 'Discreet', badge_class: 'bg-primary text-on-primary', features: ['Invisible Fit', 'Clear Sound', 'Custom Molded'], details: { ai: 'Standard', battery: 'Size 10', waterResistance: 'IP68', bluetooth: 'N/A' } },
      { name: 'BTE Behind-The-Ear Model', brand: 'Life Hearing', price: '₹1,25,000', description: 'Robust and powerful hearing aid suitable for severe to profound hearing loss, featuring easy-to-use controls.', image: '/img_bte.png', badge: 'Powerful', badge_class: 'bg-secondary text-on-secondary', features: ['High Amplification', 'Durable', 'Rechargeable'], details: { ai: 'Standard', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'Multi-Device' } },
      { name: 'RIC Receiver-In-Canal Aid', brand: 'Life Hearing', price: '₹1,80,000', description: 'A comfortable open-fit design that keeps the ear canal open for natural sound quality, ideal for mild to severe loss.', image: '/ric_hearing_aid.png', badge: 'Popular', badge_class: 'bg-tertiary text-on-tertiary', features: ['Natural Sound', 'Bluetooth Ready', 'Comfortable'], details: { ai: 'Advanced', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'Multi-Device' } },
      { name: 'CIC Completely-In-Canal', brand: 'Life Hearing', price: '₹1,65,000', description: 'Custom-molded to fit entirely inside your ear canal, offering a highly discreet cosmetic appeal.', image: '/img_invisible.png', badge: 'Custom Fit', badge_class: 'bg-primary-container text-on-primary-container', features: ['Cosmetically Appealing', 'Custom Fit', 'Clear Audio'], details: { ai: 'Standard', battery: 'Size 10', waterResistance: 'IP57', bluetooth: 'N/A' } },
      { name: 'ITC In-The-Canal', brand: 'Life Hearing', price: '₹1,70,000', description: 'Fits securely in the lower portion of the outer ear bowl, comfortable and easy to use.', image: '/img_invisible.png', badge: 'Easy Handling', badge_class: 'bg-secondary-container text-on-secondary-container', features: ['Easy to Handle', 'Custom Fit', 'Directional Mics'], details: { ai: 'Advanced', battery: 'Size 312', waterResistance: 'IP68', bluetooth: 'Optional' } },
      { name: 'ITE In-The-Ear Full Shell', brand: 'Life Hearing', price: '₹1,60,000', description: 'Fills most of the bowl-shaped area of your outer ear. Ideal for those with dexterity issues who need powerful amplification.', image: defaultImage, badge: 'Accessible', badge_class: 'bg-tertiary-container text-on-tertiary-container', features: ['Large Controls', 'Long Battery', 'Powerful Sound'], details: { ai: 'Advanced', battery: 'Size 13', waterResistance: 'IP68', bluetooth: 'Standard' } },
      { name: 'AI Powered Smart Aid', brand: 'Life Hearing', price: '₹2,50,000', description: 'Cutting-edge hearing aid utilizing Artificial Intelligence to adapt instantly to any listening environment.', image: defaultImage, badge: 'Premium AI', badge_class: 'bg-error text-on-error', features: ['AI Processing', 'Health Tracking', 'App Control'], details: { ai: 'Deep Neural Net', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'Multi-Device' } },
      { name: 'Phonak Audéo Lumity', brand: 'Phonak', price: '₹2,20,000', description: 'Experience the signature Phonak SmartSpeech technology for improved speech understanding in noisy environments.', image: '/img_bte.png', badge: 'Swiss Tech', badge_class: 'bg-primary text-on-primary', features: ['SmartSpeech', 'AutoSense OS', 'Universal Connectivity'], details: { ai: 'AutoSense 5.0', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'Universal' } },
      { name: 'Signia Silk Charge&Go', brand: 'Signia', price: '₹2,10,000', description: "The world's first rechargeable, ready-to-wear Completely-in-Canal (CIC) hearing aid by Signia.", image: '/img_invisible.png', badge: 'Innovative', badge_class: 'bg-secondary text-on-secondary', features: ['Ready to Wear', 'Rechargeable CIC', 'Binaural OneMic'], details: { ai: 'Dynamic Soundscape', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'App Control' } },
      { name: 'Starkey Genesis AI', brand: 'Starkey', price: '₹2,45,000', description: 'Completely redesigned from the inside out to deliver the most natural sounding hearing aids ever from Starkey.', image: '/starkey_aids.png', badge: 'Genesis AI', badge_class: 'bg-tertiary text-on-tertiary', features: ['Neuro Processor', 'Health Tracking', 'Edge Mode+'], details: { ai: 'Neuro Processor', battery: '51 Hours', waterResistance: 'IP68+', bluetooth: 'Direct to iOS/Android' } },
      { name: 'ReSound OMNIA', brand: 'ReSound', price: '₹2,30,000', description: 'Hear through the noise. ReSound OMNIA provides a 150% improvement in speech understanding in noisy environments.', image: '/ric_hearing_aid.png', badge: 'Noise Control', badge_class: 'bg-primary-container text-on-primary-container', features: ['Organic Hearing', 'Check My Fit', 'All-Weather'], details: { ai: 'Organic Hearing', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'MFi / ASHA' } },
      { name: 'Widex Moment Sheer', brand: 'Widex', price: '₹2,15,000', description: 'Experience pure, natural sound with ZeroDelay technology that eliminates the artificial sound of typical hearing aids.', image: defaultImage, badge: 'Natural Sound', badge_class: 'bg-secondary-container text-on-secondary-container', features: ['PureSound', 'ZeroDelay', 'SoundSense Learn'], details: { ai: 'SoundSense', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'Standard' } },
      { name: 'Oticon Real', brand: 'Oticon', price: '₹2,60,000', description: 'BrainHearing technology gives your brain access to the full sound scene, balancing sudden disruptive sounds naturally.', image: '/img_bte.png', badge: 'BrainHearing', badge_class: 'bg-tertiary-container text-on-tertiary-container', features: ['MoreSound Intelligence', 'Sudden Sound Stabilizer', 'Wind & Handling'], details: { ai: 'Deep Neural Net 2.0', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'Low Energy' } },
      { name: 'Pediatric Care Solutions', brand: 'Life Hearing', price: '₹1,40,000', description: 'Durable, tamper-proof, and brightly colored hearing aids specifically designed to support children\'s speech development.', image: '/img_pediatric.png', badge: 'For Kids', badge_class: 'bg-primary text-on-primary', features: ['Tamper-proof', 'LED Indicators', 'FM/Roger Ready'], details: { ai: 'Standard', battery: 'Rechargeable/13', waterResistance: 'IP68', bluetooth: 'FM Compatible' } }
    ];
    
    try {
      const { error } = await supabase.from('products').insert(defaults);
      if (error) throw error;
      alert("Successfully inserted 14 premium products!");
      loadProducts();
    } catch (err) {
      alert("Failed to insert defaults: " + err.message);
    }
  };
            ...
            <div className="space-y-lg">
              <div className="flex justify-between items-end border-b border-outline-variant/20 pb-md">
                ...
                <div className="flex gap-2">
                  <button onClick={handleSeedDefaultProducts} className="bg-surface-variant text-on-surface-variant px-4 py-2 rounded-xl text-sm font-bold shadow-md hover:bg-outline-variant hover:text-on-surface transition-colors flex items-center gap-1">
                    <span className="material-symbols-outlined text-[18px]">download</span> Seed Defaults
                  </button>
                  <button onClick={() => { setEditingProduct(null); setProductFormData({ name: '', brand: '', price: '', description: '', image: '', badge: '', badgeClass: 'bg-primary text-on-primary', features: '', detailsAI: '', detailsBattery: '', detailsWater: '', detailsBluetooth: '' }); setShowProductModal(true); }} className="bg-secondary text-white px-4 py-2 rounded-xl text-sm font-bold shadow-md hover:bg-secondary-container hover:text-on-secondary-container transition-colors flex items-center gap-1">
          ...
          <div className="bg-surface-container-lowest rounded-[2rem] w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl p-6 md:p-8 animate-fade-in custom-scrollbar">
            ...
            <form onSubmit={handleSaveProduct} className="space-y-4">
              ...
              <div className="pt-6 flex justify-end gap-3 border-t border-outline-variant/20 mt-2">
                ...
                <button type="submit" className="px-6 py-2.5 rounded-xl font-bold bg-primary text-on-primary hover:scale-105 shadow-md hover:shadow-lg transition-all">{editingProduct ? 'Save Changes' : 'Add Product'}</button>
              </div>
            </form>
          </div>
        </div>

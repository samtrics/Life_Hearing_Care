...
const defaultProducts = [
  { id: 'iic-1', name: 'IIC Invisible-in-Canal', brand: 'Life Hearing', price: '₹1,50,000', description: 'The smallest and most discreet hearing aid available, resting deep in the ear canal where it is completely hidden.', image: defaultImage, badge: 'Discreet', badge_class: 'bg-primary text-on-primary', features: ['Invisible Fit', 'Clear Sound', 'Custom Molded'], details: { ai: 'Standard', battery: 'Size 10', waterResistance: 'IP68', bluetooth: 'N/A' } },
  { id: 'bte-1', name: 'BTE Behind-The-Ear Model', brand: 'Life Hearing', price: '₹1,25,000', description: 'Robust and powerful hearing aid suitable for severe to profound hearing loss, featuring easy-to-use controls.', image: defaultImage, badge: 'Powerful', badge_class: 'bg-secondary text-on-secondary', features: ['High Amplification', 'Durable', 'Rechargeable'], details: { ai: 'Standard', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'Multi-Device' } },
  { id: 'ric-1', name: 'RIC Receiver-In-Canal Aid', brand: 'Life Hearing', price: '₹1,80,000', description: 'A comfortable open-fit design that keeps the ear canal open for natural sound quality, ideal for mild to severe loss.', image: defaultImage, badge: 'Popular', badge_class: 'bg-tertiary text-on-tertiary', features: ['Natural Sound', 'Bluetooth Ready', 'Comfortable'], details: { ai: 'Advanced', battery: 'Rechargeable', waterResistance: 'IP68', bluetooth: 'Multi-Device' } },
  { id: 'cic-1', name: 'CIC Completely-In-Canal', brand: 'Life Hearing', price: '₹1,65,000', description: 'Custom-molded to fit entirely inside your ear canal, offering a highly discreet cosmetic appeal.', image: defaultImage, badge: 'Custom Fit', badge_class: 'bg-primary-container text-on-primary-container', features: ['Cosmetically Appealing', 'Custom Fit', 'Clear Audio'], details: { ai: 'Standard', battery: 'Size 10', waterResistance: 'IP57', bluetooth: 'N/A' } },
  { id: 'itc-1', name: 'ITC In-The-Canal', brand: 'Life Hearing', price: '₹1,70,000', description: 'Fits securely in the lower portion of the outer ear bowl, comfortable and easy to use.', image: defaultImage, badge: 'Easy Handling', badge_class: 'bg-secondary-container text-on-secondary-container', features: ['Easy to Handle', 'Custom Fit', 'Directional Mics'], details: { ai: 'Advanced', battery: 'Size 312', waterResistance: 'IP68', bluetooth: 'Optional' } },
